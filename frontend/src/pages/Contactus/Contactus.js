...
const Contactus = () => {
  ...
  const handlesubmit = () => {
    window.open(`mailto:rsvishaltpr@gmail.com?subject=Sample&body=${body}`);
  };
  return (
        ...
        <div className="showAdrss">
          <div className="box">
            ...
            <div className="adressCtn">
              <h3> Address</h3>
              <p>Salem Main Road, Near Power Office, Komarapalayam - 638183</p>
            </div>
          </div>
          <div className="box">
            <div className="iconCtn">
            ...
            <div className="adressCtn">
              <h3>Fit Wear</h3>
              <p className="infoCtn">0987654321</p>
            </div>
          </div>
          <div className="box">
            <div className="iconCtn">
            ...
            <div className="adressCtn">
              <h3>Sale Support</h3>
              <p className="infoCtn">contactus@fitwear.com</p>
            </div>
          </div>
        </div>
      </div>
