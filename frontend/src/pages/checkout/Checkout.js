...
import { Input,  Image, Link } from "@chakra-ui/react"
...
const Checkout = ({history}) => {
    ...
    const handleorder = (e)=>{
        e.preventDefault()
         dispatch(saveAddressshipping({ address, city, postalCode}))
                ...
                <div className="info-check">
                    ...
                    <div className="billing-check">
                        ...
                        <div className="city-cp-check">
                            ...
                            <div><label for="zip" className="this-label" >Pin Code</label>
                            <Input variant="flushed" required placeholder="Your Pincode" id="zip" onChange = {(e) => setPostalCode(e.target.value)}/></div>
                        </div>
                    </div>
                    ...
                    <div className="payment-check">
                        ...
                        <Input variant="flushed" id="name-card" placeholder="Name on Card"/></div>
                        ...
                        <input onChange = {(e)=> {setcarddetails(false) ; setPayment('cod')}} type="radio" name="payment" id="cod"/><label for="cod" className="this-label"> COD</label>
                        <div class="confirm">
