...
const ProductsC = ({match,history}) => {
    ...
    return (
        ...
        <div className = 'Cgfilter'>
            ...
            </div>{/*Nav bar in the top of the /shop page  */}
        </div>
        ...
        <div className = 'pricediv'>
        ...
        </div> {/* filter button filtering option price from and to */}
            ...
            : error ? <h2>{error} </h2> 
            : products.length === 0 ?  <h1 className = 'nothingfound'>Nothing Found !!!!!</h1> : <div className='cardsProduct'>
