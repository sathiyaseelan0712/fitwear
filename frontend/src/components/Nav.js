...
import { IoCloseOutline, IoMdArrowDropdown } from 'react-icons/io';
import { MdSearch, MdKeyboardArrowRight } from 'react-icons/md';
import { BsArrowRightShort } from 'react-icons/bs';
import { IoLogOutOutline, IoChevronDownCircleOutline } from 'react-icons/io5';
 ...
 const Nav = ({history}) => {
    ...
    return (
       <nav ref = {Nav}  className={`nav ${nav ? 'active' : ''}`} >
           <div className="logo"><Link to =''>WEB CLOTHING</Link></div>
